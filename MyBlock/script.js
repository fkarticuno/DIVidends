...
var housingarray = ["townhouse/rowhouse","duplex","apartment","condominium", "triplex"]
...
$('#housing').on('click',function(){
    ...
    $('#icon').html(`<img class="icon" src="forsale.png"/>`)
...
$(document).on('click', ".schoolChoice", function() {
  ...
  foodSearch(schoolTerm)
    ...
    function homeSearch(x){
            ...
            var myurl = "https://api.gateway.attomdata.com/propertyapi/v1.0.0/property/snapshot?postalcode=23229&propertytype="+x
        ...
        //                 // Grab the results from the API JSON return
            ...
            console.log(houseResults);
              ...
              for (var i = 0; i < houseResults.length; i++) {
                var houseAddress = houseResults[i].address.oneLine;
                var addressDiv = $('<div>');
                addressDiv.text(houseAddress);
                $('#results').prepend(addressDiv, "<br><br>");
